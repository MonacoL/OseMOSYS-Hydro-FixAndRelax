...
argomenti=str(sys.argv)
argomenti=argomenti.replace('[',"").replace(']',"").replace(','," ").replace(chr(39),"").split()

path=argomenti[1]
pathDatiRun=argomenti[2]
PastOrFuture=argomenti[3]
scartoupper=int(argomenti[4])
scartolower=int(argomenti[5])
sys.path.insert(0, path[:-7])
